...
const positionConfigure: IPositionConfigure[][] = [
  ...
  [
    {
      name: "水原以北白云山地区机动防御战斗",
      position: [-30, 4, -30],
      bothSides: ["美第２５师２个团", "志第５０军第４４７团"],
      results: "歼敌１２００余人，迟滞了敌人进攻。",
    },
    {
    ...
    },
    {
      name: "山中反击作战",
      position: [-30, 4, -30],
      bothSides: ["美第２４师第１９团", "志第３８军第３３８团及第３３９团一部"],
      results:
        "粉碎敌人迂回我第３８军第１１３师汉江南阵地、割裂我军汉江南北联系的企图，歼敌４８６名。",
    },
    {
      name: "横城反击战役",
      position: [-30, 4, -30],
